...
export const events: EventItem[] = [
  // 1. WORKSHOPS
  {
    ...
    host: { name: "OpenKernel Community", role: "Verified Organizer" },
    speakers: [
  ...
  // 2. HACKATHONS
  {
    ...
    host: { name: "DevSphere Foundation", role: "Verified Organizer" },
    speakers: [
  ...
  // 3. SEMINARS
  {
    ...
    host: { name: "IISc Research Collective", role: "Verified Organizer" },
    speakers: [
  ...
  // 4. WEBINARS
  {
    ...
    host: { name: "Enginow Product Network", role: "Verified Organizer" },
    speakers: [
  ...
  // 5. COMPETITIONS
  {
    ...
    host: { name: "AlgoStrike League", role: "Verified Organizer" },
  ...
  // 6. BOOTCAMPS
  {
    ...
    host: { name: "Enginow Academy", role: "Verified Organizer" },
    speakers: [
  ...
  // 7. CONFERENCES
  {
    ...
    host: { name: "DevSphere Communities", role: "Verified Organizer" },
    speakers: [
  ...
  // 8. TECH TALKS
  {
    ...
    host: { name: "Rust India Community", role: "Verified Organizer" },
  ...
  // 9. COMMUNITY EVENTS
  {
    ...
    host: { name: "Enginow Open Source Guild", role: "Verified Organizer" },
    speakers: [],
    sponsors: [{ name: "GitHub" }, { name: "WeWork" }],
    faqs: [
      { q: "Is this event free?", a: "Yes, free for all community members. RSVP is required for security check-in." },
    ],
    contactEmail: "community@enginow.io",
  ...
  // 10. COLLEGE FESTIVALS
  {
    ...
    host: { name: "IIT Madras Tech Council", role: "Verified Organizer" },
  ...
  // 11. NETWORKING EVENTS
  {
    ...
    host: { name: "Ignite Venture Network", role: "Verified Organizer" },
    speakers: [
...
export const categoryMeta: Record<string, { icon: string; description: string; color: string }> = {
  ...
  Hackathons: { icon: "⚡", description: "Multi-day build sprints", color: "from-violet-500/20 to-purple-500/20 border-violet-500/20" },
  Hackathon: { icon: "⚡", description: "Multi-day build sprints", color: "from-violet-500/20 to-purple-500/20 border-violet-500/20" },
  ...
  "College Festival": { icon: "🎓", description: "Inter-collegiate technical fests", color: "from-purple-500/20 to-violet-500/20 border-purple-500/20" },
  ...
  Networking: { icon: "🌐", description: "High-signal mixer & connections", color: "from-teal-500/20 to-emerald-500/20 border-teal-500/20" },
};
