...
const roles = [
  {
    ...
    actions: ["Discover Events", "Build Portfolio", "Win Prizes"],
  },
  {
    ...
    actions: ["Publish Events", "QR Check-in", "Live Analytics"],
  },
  {
    role: "Administrator",
    title: "Verify & Govern",
    ...
    actions: ["Verify Credential", "Event Approval", "Platform Moderation"],
  },
];
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
            ...
            return (
              <ScrollReveal key={r.role} delay={i * 0.1} direction="up">
                <motion.div
                  ...
                  className={`h-full bg-card/80 backdrop-blur-xl border ${r.border} rounded-3xl p-8 flex flex-col justify-between shadow-xl relative overflow-hidden group`}
                >
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-6">
                      <div className={`p-3 rounded-2xl ${r.badgeBg} border border-current/20`}>
                    ...
                    <div className="mt-6 flex flex-col gap-2">
                      {r.actions.map((act) => (
                        <div
                          key={act}
                          className="flex items-center gap-2 text-xs font-medium text-foreground/80 bg-secondary/50 px-3 py-2 rounded-xl"
                        >
                  ...
                  <div className="mt-8 pt-4 border-t border-border/40">
                    <Link
                      to="/auth"
                      className="inline-flex items-center gap-2 text-xs font-semibold text-primary hover:underline group-hover:translate-x-1 transition-transform"
                    >
        ...
        <ScrollReveal delay={0.3} className="mt-14">
          <div className="bg-gradient-to-r from-primary/10 via-primary/5 to-accent/10 border border-primary/20 rounded-3xl p-8 text-center flex flex-col sm:flex-row items-center justify-between gap-6 shadow-lg">
            ...
            <Link
              to="/auth"
              className="shrink-0 h-11 px-6 bg-primary text-primary-foreground font-semibold text-sm rounded-xl hover:opacity-90 transition-all shadow-[0_0_20px_-4px_var(--primary-glow)] flex items-center gap-2 active:scale-95"
            >
